...
#GUI Variables
$FormTitleText = "Dọn Đĩa của Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "Chọn đĩa:"
$FreeSpaceLabelText = "Dung lượng trống (gigabyte):"
$TotalSpaceLabelText = "Tổng dung lượng (gigabyte):"
$JunkFoundLabelText = "đã tìm thấy rác (gigabyte):"
$CleanDiskBtnText = "Làm sạch đĩa *Xóa tập tin*"
$SpaceCleanedLabelText = "Dung lượng đã dọn dẹp (gigabyte):"
$LogFileLabelText = "Đã tìm thấy tệp nhật ký: $abcdefg"
$CreditLabelText = "Kịch bản của Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "Đã tìm thấy tệp nhật ký"
$AnalyzingDriveText = "Đang phân tích ổ đĩa..."
$BrowsersAreRunningText = "Trình duyệt đang chạy... Thông báo cho người dùng..."
$PleaseCloseBrowsersText = "Vui lòng đóng tất cả các trình duyệt web và thử lại."
$CleaningDriveText = "Dọn dẹp ổ đĩa..."
